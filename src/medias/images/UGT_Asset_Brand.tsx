...
export const ImgBrand: React.FunctionComponent<ImgBrandProps> = ({ alt, ...props }) => (
  ...
  >
    ...
    />
    <path
      d="M10.6816 54.4636C15.7895 58.9193 22.2232 61.5679 28.9875 61.9999V36.125L10.6816 54.4636Z"
      fill="#FFD500"
    />
    <path
    ...
    />
    <path
      d="M33.2197 61.987C39.9103 61.5145 46.2644 58.8732 51.3184 54.4636L33.2197 36.125V61.987Z"
      fill="#FFD500"
    />
  </svg>
);
